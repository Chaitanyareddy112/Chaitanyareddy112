...
public class AAdactintestng {
	  ...
	  @Test(priority=2, dependsOnMethods="newregistration")
		  ...
		  driver.findElement(By.name("password")).sendKeys("12121");
	driver.findElement(By.name("login")).click();
	  ...
	  public void beforeClass() {
		  ...
		  System.setProperty("webdriver.chrome.driver", "C:\\Users\\vcred\\Downloads\\chromedriver_win32 (8)\\chromedriver.exe");
